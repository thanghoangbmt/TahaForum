...
public class PaginationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ArticleDTO> indexList = articleDAO.getListArticleAvailable(pattern, pageID, total);

            int numberOfArticles = articleDAO.getNumberOfAvailableArticleByTitle(pattern);
            ...
            LOGGER.error("Error at IndexController: " + e.toString());
        } finally {
